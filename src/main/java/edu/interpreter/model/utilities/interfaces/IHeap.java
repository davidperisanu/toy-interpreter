...
public interface IHeap<Key, Value> extends Serializable {
     ...
     * @param item The object to add to the <code>IHeap<></code> elements collection.
     */
    public void add(Key key, Value value);
    
    /**
    * Determines whether the <code>IHeap<></code> contains the specified key.
    * @param key The key to locate in the <code>IHeap<></code>.
    * @return A boolean value which indicates whether the specified key exists or not.
    */
    public boolean contains(Key key);
    
    /**
    * Gets the value with the specified key from the <code>IHeap<></code>.
    ...
    */
    ...
    /**
    * Removes the value with the specified key from the <code>IHeap<></code>.
